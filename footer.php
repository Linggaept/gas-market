            ...
            <div class="container-fluid text-center text-md-left">
                <div class="row text-white">
                    <div class="col-md-2 mx-auto">
                        ...
                        Toko Sendal Minimarket adalah sebuah situs web yang menjual berbagai macam sendal berkualitas untuk kebutuhan sehari-hari di rumah maupun untuk keperluan luar rumah.
                        <br>
                    ...
                    <div class="col-md-2 mx-auto">
                        ...
                        <ul class="list-unstyled">
                            +62 852-1535-8216 <br>
                            tokosendalminimarket@gmail.com <br>
                            Jl Petir Utama, Pasar Rubuh
                        </ul>
                    </div>
                </div>
            </div>
            <div class="footer-copyright text-center py-3 bg-dark text-white">©2025 Copyright :
                <a href="index.php"> Toko Sendal Minimarket</a>
            </div>
        </div>
    </footer>
